...
@Component({
  selector: 's-other-allocate-search',
  templateUrl: './other-allocate-search.component.html',
  styleUrls: ['./other-allocate-search.component.less']
})
export class OtherAllocateSearchComponent implements OnInit {
