...
@Component({
    selector: 's-order-teardown-search',
    templateUrl: './order-teardown-search.component.html',
    styleUrls: ['./order-teardown-search.component.less']
})
export class OrderTeardownSearchComponent implements OnInit {
