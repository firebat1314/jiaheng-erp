...
@Component({
    selector: 's-other-output-search',
    templateUrl: './other-output-search.component.html',
    styleUrls: ['./other-output-search.component.less']
})
export class OtherOutputSearchComponent implements OnInit {
