...
@Component({
  selector: 's-other-warehousing-search',
  templateUrl: './other-warehousing-search.component.html',
  styleUrls: ['./other-warehousing-search.component.less']
})
export class OtherWarehousingSearchComponent implements OnInit {
